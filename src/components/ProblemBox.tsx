...
const ProblemBox: React.FC<ProblemProps> = ({
    ...
    return (
    <div 
        className={`transition-bg border border-gray-300 mx-2 mx-auto rounded-lg shadow-lg overflow-hidden flex flex-col h-[330px] w-[500px] ${isHovered ? 'bg-secondary' : 'bg-white'}`}
