...
const LandingPage = () => {
    ...
    return (
        <div className="flex h-full flex-col bg-cover bg-top bg-no-repeate bg-form">
            <Navbar />
            <div className="flex w-full flex-grow pl-40 xl:pl-48 2xl:pl-[22rem] overflow-hidden">
                <div className="flex-1 flex flex-col items-start">
                    <div className="w-full grid gap-3 2xl:gap-5 py-36 xl:py-48 2xl:py-64 grid-cols-1 justify-between align grow">
                        <HoverCard
                            className="-translate-y-5 2xl:-translate-y-10 w-1/2 max-w-1/2 2xl:w-2/5 2xl:max-w-2/5"
                            title="Code & Learn"
                        ...
                        />
                        <HoverCard
                            className="translate-x-[50%] w-1/2 max-w-1/2 2xl:w-2/5 2xl:max-w-2/5"
