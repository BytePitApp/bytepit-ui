        ...
        <div
            ...
            <div className="flex w-full flex-grow">
                <div className="w-[45%] flex flex-col items-center justify-between p-10 bg-primary/10 bg-opacity-70">
                    <BubbleText />
                    <div className="border-l-2 border-black p-5 flex flex-col gap-5 mb-[20%]">
                ...
                <div className="flex-1 h-2/3 flex justify-center items-center mt-20">
                    <div className="grid w-4/5 gap-10 py-32 grid-flow-col overflow-hidden">
                        <HoverCard
                        ...
                        <HoverCard
                            ...
                            subtitle="Create problems and publish them for real coding challenge"
                            Icon={IoCalendar}
                            href="/register"
                        />
                    </div>
